...
//             <input type="tel" name="phone" value={formData.phone} onChange={handleChange} placeholder="Phone Number" required className="w-full p-3 border rounded-lg" />
//             <input type="password" name="password" value={formData.password} onChange={handleChange} placeholder="Password" required className="w-full p-3 border rounded-lg" />
//             <button type="submit" disabled={loading} className="w-full bg-orange-500 text-white font-bold py-3 rounded-lg hover:bg-orange-600 transition-colors disabled:opacity-50">
...
//             <p className="text-center text-gray-600">Enter the 6-digit code sent to <strong>{formData.email}</strong></p>
//             <input type="text" name="otp" value={formData.otp} onChange={handleChange} placeholder="Enter 6-Digit OTP" required maxLength="6" className="w-full p-3 border rounded-lg text-center text-xl tracking-widest" />
//             <button type="submit" disabled={loading} className="w-full bg-blue-700 text-white font-bold py-3 rounded-lg hover:bg-blue-800 transition-colors disabled:opacity-50">
//               {loading ? 'Verifying...' : 'Verify & Complete Signup'}
//             </button>
//             <button type="button" onClick={() => setStep(1)} className="w-full text-sm text-gray-500 hover:text-blue-600 mt-2">
//               Go Back
//             </button>
//           </form>
//         )}
